...
const UpdateProduct: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-12 p-6 bg-white shadow-xl rounded-xl border border-gray-200">
      <Link
        to="/"
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border border-gray-300 rounded-lg p-3 h-32 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition resize-none"
          />
        </div>
      ...
      focus:ring-indigo-500 focus:border-indigo-500 transition"
        ...
        <button
          type="submit"
          className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold p-3 rounded-lg shadow-md transition"
        >
